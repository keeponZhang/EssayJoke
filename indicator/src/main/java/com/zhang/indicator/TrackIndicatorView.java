...
//                mIndicatorGroup.getItemAt(i).getLayoutParams().width = mItemWidth;
                Log.d(TAG, "onLayoutwidth:"+mIndicatorGroup.getItemAt(i).getLayoutParams().width);
            }
    ...
    public int getItemWidth() {
        ...
        Log.d(TAG, "getItemWidth:"+parentWidth);
    ...
    private void scrollCurrentIndicator(int position, float positionOffset) {
        ...
        // 最终的一个偏移量
        final int finalScroll = (int) (totalScroll - offsetScroll);
        Log.e(TAG, "scrollCurrentIndicator totalScroll :"+totalScroll+"  offsetScroll="+offsetScroll+"  finalScroll="+finalScroll);
        // 调用ScrollView自带的方法
