...
//                        cursor.getFloat(columnIndex);
                        // cursorMethod.invoke(cursor, index)
                        ...
                        if (cursorMethod != null) {
                            ...
                            // 处理一些特殊的部分（与getColumnMethodName对应）
...
//        values.put("flag",person.getFlag());
        ...
        for (Field field : fields) {
            try {
                ...
                // 源码里面  activity实例 反射  View创建反射（AppCompatViewInflater.createViewFromTag）
